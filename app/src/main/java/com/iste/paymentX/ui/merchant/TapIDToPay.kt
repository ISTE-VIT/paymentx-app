...
class TapIDToPay : AppCompatActivity() {
...
//    private lateinit var submitButton: Button
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_tap_idto_pay)
        AppCompatDelegate.setDefaultNightMode(AppCompatDelegate.MODE_NIGHT_FOLLOW_SYSTEM)
        requestedOrientation = ActivityInfo.SCREEN_ORIENTATION_PORTRAIT

        // Initialize TextView
        or_text = findViewById(R.id.merchor_text)

        /// Get and verify amount
        amount = intent.getIntExtra("EXTRA_AMOUNT", 0)

        val amountText = findViewById<TextView>(R.id.amount_edit)
        amountText.text = "Tap ID to Pay ₹$amount"
    ...
    private fun displayUid(tag: Tag) {
        try {
            ...
            val displayIntent = Intent(this, FetchCustomerPIN::class.java).apply {
