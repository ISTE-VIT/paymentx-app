...
class MerchTransactionAdapter(
    ...
    override fun onBindViewHolder(holder: TransactionViewHolder, position: Int) {
        ...
        // Set user name
        holder.userName.text = transaction.userName ?: "Unknown User"

        // Set amount with currency symbol
        holder.amount.text = "₹${transaction.amount}"

        // For debugging - print the timestamp to logcat
        android.util.Log.d("MerchTransactionAdapter", "Original timestamp: ${transaction.timestamp}")
    ...
    private fun formatTimestamp(timestamp: String): Pair<String, String> {
        ...
        try {
            ...
            android.util.Log.d("MerchTransactionAdapter", "Failed to parse timestamp: $timestamp")
