...
import com.iste.paymentX.ui.main.EditProfile
import kotlinx.coroutines.launch
import kotlinx.coroutines.tasks.await
import retrofit2.HttpException
import java.io.IOException

class UpdatePhoneOtpVerification : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_update_phone_otp_verification)
    ...
    private fun attachPhone(phoneNumber: String) {
        lifecycleScope.launch {
            ...
            if (token != null) {
                ...
                Toast.makeText(
                    this@UpdatePhoneOtpVerification,
