...
import com.iste.paymentX.ui.auth.UpdatePhoneOtpVerification

class MerchantUpdatePhoneNumber : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_merchant_update_phone_number)
    ...
    private fun navigateToOtpVerification(phoneNumber: String) {
        ...
        val intent = Intent(this, MerchantUpdatePhoneOtpVerification::class.java).apply {
            putExtra("phoneNumber", phoneNumber)
            putExtra("MERCHANT_NAME", userName)
            putExtra("MERCHANT_EMAIL", userEmail)
        }
